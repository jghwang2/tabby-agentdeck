...
const { readAccounts, addAccount, parseQuotas, parseCodexUsage, accountHome, prepareAccount, accountEmail, saveAccountAuth, restoreAccountAuth, pendingMarketplaceSeed } = require('../.tmp/accounts')
...
addAccount('claude', 'second@example.test', 'second-password', addedFile)
